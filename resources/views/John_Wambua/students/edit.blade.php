...
@section('content')
    ...
    <div style=" max-width: 45em;" class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <div class="card" style="color: #1b1e21">
            <h5 class="card-header"><strong>Update Student Data</strong></h5>
            @if ($errors->any())
            ...
            <div class="card-body">
                ...
                <form method="post" action="/students/{{$student->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="student_number" value="{{$student->student_number}}" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <a href="/students/{{$student->id}}" class="btn btn-danger">Cancel</a>
                </form>
            </div>
        </div>
        @stop
